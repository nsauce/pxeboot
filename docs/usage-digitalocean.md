...
Obtain an iPXE generic kernel [here](https://boot.degree9.io/ipxe/generic-ipxe.lkrn) or [compile your own](http://ipxe.org/download) and save it to /boot/generic-ipxe.lkrn.
